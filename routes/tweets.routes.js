...
const Tweet = require('../database/models/tweet.model');//importation du model Mongoose pour creer un new doc mongoose à chaque requête de POST sur route/api/tweets
